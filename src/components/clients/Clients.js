...
const Clients = () => {
  ...
  return (
    <div className="md:py-16">
      ...
      <animated.div
        style={slider}
        className="client container  rounded-3xl text-1 mx-auto grid grid-cols-2 lg:grid-cols-8 md:grid-cols-4 gap-y-4 p-5"
      >
        <div className="img">
          <img src={img_1} alt="" />
        </div>
        ...
        <div className="img">
          <img className="bg-gray-700 px-3 rounded-md" src={img_4} alt="" />
        </div>
        <div className="img">
          <img src={img_5} alt="" />
        </div>
        ...
        <div className="img">
          <img className="" src={img_10} alt="" />
        </div>
        <div className="img">
          <img className="bg-gray-700 px-3 rounded-md" src={img_11} alt="" />
        </div>
        <div className="img">
          <img src={img_12} alt="" />
        </div>
        <div className="img">
          <img className="bg-gray-700 px-3 rounded-md" src={img_13} alt="" />
        </div>
        <div className="img">
          <img className="bg-gray-700 px-3 rounded-md" src={img_14} alt="" />
        </div>
        <div className="img">
          <img src={img_15} alt="" />
        </div>
