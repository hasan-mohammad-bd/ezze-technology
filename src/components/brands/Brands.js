...
const Brands = () => {
    return (
        ...
        <div className='py-10'>
                <h3 className="text-3xl md:text-5xl font-bold py-10 text-center">Co - Brands</h3>
            <div className='client container rounded-3xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4'>
                <div className="img bg-gray-300 px-3 py-1 rounded-lg "><img className='' src={img_1} alt="" /></div>
