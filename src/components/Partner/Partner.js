...
<div className="img"><img className='rounded-md' src={img_3}alt="" /></div>
<div className="img"><img src={img_4}alt="" /></div>
<div className="img"><img src={img_5}alt="" /></div>
<div className="img"><img src={img_6}alt="" /></div>
<div className="img"><img src={img_7}alt="" /></div>
<div className="img"><img className='rounded-md' src={img_8}alt="" /></div>
<div className="img"><img className='rounded-md' src={img_9}alt="" /></div>
<div className="img"><img className='rounded-xl' src={img_10}alt="" /></div>
<div className="img"><img className='rounded-md' src={img_11}alt="" /></div>
<div className="img"><img src={img_12}alt="" /></div>
<div className="img"><img src={img_13}alt="" /></div>
<div className="img"><img className='rounded-md' src={img_14}alt="" /></div>
